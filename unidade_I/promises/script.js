...
//Adicionando Then
document.getElementById("botaoCerveja").addEventListener("click", () => {
    exibirMensagem().then(console.log);
    carregarApi(cervejas, apiCerveja, cabecalioCervs, colunasCervs);
});
